...
# Обучение модели MiniBatchKMeans для Bag-of-Words
kmeans_bow = MiniBatchKMeans(n_clusters=num_clusters, init='k-means++', batch_size=100, max_iter=100, n_init=1)
kmeans_bow.fit(X_bow)

# Обучение модели MiniBatchKMeans для TF-IDF
kmeans_tf = MiniBatchKMeans(n_clusters=num_clusters, init='k-means++', batch_size=100, max_iter=100, n_init=1)
kmeans_tf.fit(X_tf)
...
plt.title('MiniBatchKMeans Clustering with Bag-of-Words')
...
plt.title('MiniBatchKMeans Clustering with TF-IDF')
plt.xlabel('Principal Component 1')
plt.ylabel('Principal Component 2')
