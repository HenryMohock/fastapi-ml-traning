...
def perform_text_analysis(text, chunk_size, type_tokenization, n, sent_an_proc, chunk_sent):
    """
    ...
    try:
        if input("Хотите выполнить анализ текста? (yes/no): ").lower() == "yes":
            ...
            txt_analysis = TextAnalysis(text, chunk_size, type_tokenization, n, sent_an_proc, chunk_sent)
